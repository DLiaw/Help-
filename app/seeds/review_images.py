...
def seed_review_image():
    ...
    name2 = ReviewImage(
        review_id = 1,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/InA4KMDgrnnldwXFwSSq-g/o.jpg"
    )
    name3 = ReviewImage(
        review_id = 1,
    ...
    name8 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/7BRgtG8X6xOssC9-4RafqA/o.jpg"
    )
    name9 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/uek0diWr1CH9isfk3DRJbw/o.jpg"
    )
    name10 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/2rWs4DpxV6clMvB8BUeApg/o.jpg"
    )
    name11 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/fNYyOSDWhtsqLvnEyVQooQ/o.jpg"
    )
    name12 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/dlCkTt51axh4GjfE-0P8Kg/o.jpg"
    )
    name13 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/JgABIJfM_aMPPlqABUQLqA/o.jpg"
    )
    name14 = ReviewImage(
        review_id = 2,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/xXMEQsszSnK_gZX_eT0RxQ/o.jpg"
    )
    name15 = ReviewImage(
        review_id = 3,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/_aNvh4Kz6RSZoO-w6CcLMQ/o.jpg"
    )
    name16 = ReviewImage(
        review_id = 3,
    ...
    name29 = ReviewImage(
        review_id = 5,
        review_image= "https://s3-media0.fl.yelpcdn.com/bphoto/BmpJmlqXF513SyHs3OjJuw/o.jpg"
    )
    name30 = ReviewImage(
        review_id = 5,
